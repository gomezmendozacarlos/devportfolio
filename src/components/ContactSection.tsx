        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-8 sm:mb-12">
            ...
            <button
              ...
              className="group flex items-center justify-center gap-3 p-4 sm:p-6 bg-green-600 hover:bg-green-700 text-white rounded-xl font-medium transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
            >
            ...
            <button
              ...
              className="group flex items-center justify-center gap-3 p-4 sm:p-6 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
            >
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center gap-4 sm:gap-6">
              ...
              <a
                ...
                className="group flex items-center gap-2 px-4 sm:px-6 py-3 sm:py-4 bg-gray-800 hover:bg-gray-900 text-white rounded-xl font-medium transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center gap-2 px-4 sm:px-6 py-3 sm:py-4 bg-blue-700 hover:bg-blue-800 text-white rounded-xl font-medium transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
              >
                <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 24 24">
